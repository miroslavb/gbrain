...
export const EXTRACTOR_SYSTEM = [
  ...
  '- One fact per atomic claim. Split independent clauses joined by and/while/causing; if a',
  '  clause is not independently durable, omit it instead of making a compound fact.',
  '- Never introduce because/caused/led to/due to/worsened/enabled unless the speaker',
  '  explicitly states that causal relationship; preserve the speaker\'s causal wording.',
  '- Cap at 10 facts per turn.',
