...
export const DEFAULT_HARD_EXCLUDES: string[] = [
  ...
  'attachments/',
  '.raw/',
  // Uploaded documents are served only through the caller-aware document ACL broker.
  // Keep legacy docs/inbox pages in the DB for non-destructive migration/read-back,
  // but never admit them to ordinary keyword/vector/hybrid candidate sets.
  'docs/inbox/',
];
